...
while run:
    ...
    if x > 300 and x < 350 and y < 100 and y > 50 and screenid == "10":
        ...
        time.sleep(2)
        message_to_screen("Get ready to die",green,(150,300))
        pygame.display.update()
        time.sleep(3)
        pygame.draw.rect(win,(0,0,255),(0,300,400,100),0)
        pygame.display.update()
        message_to_screen("Virgin",green,(150,300))
        pygame.display.update()
        time.sleep(3)
        x = 200
        y = 350
        walkRight = pygame.image.load('pakit.png')
        walkLeft = pygame.image.load('pakit.png')
        char = pygame.image.load('pakit.png')
        charup = pygame.image.load('pakit.png')
        bg = pygame.image.load('pakit.png')
        raja1 = 0
        raja2 = 400 - width
        raja3 = 0
        raja4 = 400 - height
    ...
    if x > 700 and kypara == 0 and screenid == "10":
        message_to_screen("Kuolit, ei varmaan kannattais kävellä autotielle vitun idiootti",(255,10,0),(220,180))
        pygame.display.update()
        time.sleep(5)
        break
        
        sys.exit(0)
    elif x > 700 and kypara == 1 and screenid == "10":
